...
silent only
cd ~/dev/wiki-articles
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 version-control.md
args version-control.md
edit version-control.md
...
setlocal tabstop=2
setlocal tags=~/dev/wiki-articles/.git/markdown.tags,~/dev/wiki-articles/.git/tags,./tags,tags
